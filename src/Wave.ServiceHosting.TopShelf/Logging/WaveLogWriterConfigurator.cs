...
namespace Wave.ServiceHosting.TopShelf.Logging
{
    ...
    /// </summary>
    [Serializable]
    class WaveLogWriterConfigurator : HostLoggerConfigurator
    {
        private readonly ILogger internalLog;

        public WaveLogWriterConfigurator(ILogger log)
        {
        ...
        {
            return new WaveLogWriterFactory(internalLog);
        }
    }
}
